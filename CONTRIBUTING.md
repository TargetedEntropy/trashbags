...
Welcome to `trashbags` contributor's guide.
...
If you experience bugs or general issues with `trashbags`, please have a look
...
You can help improve `trashbags` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`trashbags` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `trashbags`'s files. While this mechanism can
...
```
conda create -n trashbags python=3 six virtualenv pytest pytest-cov
conda activate trashbags
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/trashbags.git
   cd trashbags
   ```
...
5. Install [pre-commit]:
   ...
   `trashbags` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/trashbags
[issue tracker]: https://github.com/<USERNAME>/trashbags/issues
